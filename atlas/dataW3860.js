var imageW = 3560, imageH = 7256;
var image = "waterdeep-3560-7256.jpg", imageMob = "waterdeep-1780-3628.jpg", mini = "smallW.jpg";
var lineFocus = 12; var dotWidth = 12, dotTrait = 3, zoomMax=1, zoomCelMax=1;
var carte = "W", factorDist = 310;
var bilang = 0; 
...
{ name:"Black Cat Way", color:"#FFFFFF", x:2450, y:2918, txt:"<p>Street</p>"},
{ name:"Spices Street", color:"#FFFFFF", x:2400, y:5680, txt:"<p>Street</p>"},
{ name:"Fishgut Alley", color:"#FFFFFF", x:2510, y:5712, txt:"<p>Street</p>"},
{ name:"Cedar Street", color:"#FFFFFF", x:2604, y:5852, txt:"<p>Street</p>"},
{ name:"Slop Street", color:"#FFFFFF", x:2674, y:5664, txt:"<p>Street</p>"},
{ name:"Shesstra's Street", color:"#FFFFFF", x:2273, y:4673, txt:"<p>Street</p>"},
{ name:"Wharf Street", color:"#FFFFFF", x:2551, y:5686, txt:"<p>Street</p>"},
{ name:"Turnback Court", color:"#FFFFFF", x:1157, y:3353, txt:"<p>Alley</p>"},
{ name:"Fishnet Alley", color:"#FFFFFF", x:2467, y:5677, txt:"<p>Linking Spice Street and Dock Street in a dogleg west of Wharf Street, this narrow crowded alley gets its name from the drying nets that are hung across it at various levels from wall hooks by night or for repair by day. Down the years, these nets have broken the fall of many thieves and lovers leaping from windows, or have been dropped from above by thugs to entrap people passing along the alley. Although it looks like the web-choked lair of some giant spider, this alley is usually quite safe.</p>"},
